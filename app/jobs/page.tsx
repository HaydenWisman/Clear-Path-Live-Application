    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: '28px' }}>
          <div style={eyebrow}>Browse Jobs</div>
          <h1 style={titleStyle}>Open roles</h1>
          <p style={subStyle}>
            Explore live recruiter-posted roles with salary, work type, experience level,
            certifications, company context, and recruiter details.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <p style={{ color: '#94a3b8' }}>No jobs available yet.</p>
        ) : (
          <div
            style={{
              display: 'grid',
          ...
          >
            {jobs.map((job) => (
              <div key={job.id} style={cardStyle}>
                <div style={{ fontSize: '30px', fontWeight: 800, marginBottom: '8px' }}>{job.title}</div>
                ...
                <div style={sectionLabel}>Company History</div>
                <div style={{ color: '#cbd5e1', lineHeight: 1.6, marginBottom: '12px' }}>
                  {job.company_history || 'No company history provided.'}
                </div>

                <div style={sectionLabel}>Core Values</div>
                <div style={{ color: '#cbd5e1', lineHeight: 1.6, marginBottom: '12px' }}>
                  {job.core_values || 'No core values provided.'}
                </div>
